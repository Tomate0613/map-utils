package dev.doublekekse.festlyutils.command.argument;
...
public class PathArgumentType implements ArgumentType<PositionAndRotation[]> {
    public static final SimpleCommandExceptionType ERROR_NOT_COMPLETE = new SimpleCommandExceptionType(Component.translatable("argument.festly-utils.path.incomplete"));
    public static final SimpleCommandExceptionType ERROR_NOT_ENOUGH_NODES = new SimpleCommandExceptionType(Component.translatable("argument.festly-utils.path.not_enough_nodes"));
    public static final SimpleCommandExceptionType ERROR_NO_SEMICOLON = new SimpleCommandExceptionType(Component.translatable("argument.festly-utils.path.no_semicolon"));
